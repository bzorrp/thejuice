                ...
                <div className="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
                    <div
                        ...
                        <div className="flex flex-col">
                            <h1 className="text-2xl text-gray-900 dark:text-gray-100">{juice.name}</h1>
                            <p className="text-sm text-gray-500 dark:text-gray-300">NGN {juice.price.toLocaleString()}</p>
                            <div className="py-8 flex flex-col">
                                <h1 className="font-bold text-gray-900 dark:text-gray-100">Nutritional Information</h1>
                                <div className='text-sm text-gray-500 dark:text-gray-300'>
                                    <ul className='list-disc px-4 font-semibold'>
                                        <li>Calories (per 1 cup, 240ml): 110 kcal</li>
                                        ...
                                        <li>Vitamins/Minerals:
                                            ...
                                            High in Vitamin C (124% of daily value)
                                            Contains small amounts of folate, potassium, and thiamine.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div className="flex gap-4">
                                ...
                                {juiceInCart &&
                                    <input type="number" min={0} max={100} defaultValue={juiceInCart.quantity}
                                           readOnly={updatingCart}
                                           onChange={(event) => updateCart(event.target.valueAsNumber)}/>}
